...
/** item = nombre del icono real del juego (imagen de la wiki); icon = fallback emoji */
const RESOURCES = [
  { id: 'metal', label: 'Metal', item: 'Metal', icon: '⛏️', color: '#c8d2dc' },
  { id: 'metal-rico', label: 'Metal rico', item: 'Metal', icon: '⛰️', color: '#ffcf6b' },
  ...
  { id: 'plantas', label: 'Plantas Y/R', item: 'Plant Species Y Seed', icon: '🌱', color: '#8ce68c' },
] as const
