...
export function DinoFootprint({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-hidden="true">
      ...
      {/* almohadilla */}
      <ellipse cx="16" cy="21" rx="7.5" ry="6.5" fill="url(#ambergrad)" />
      {/* dedos */}
      <ellipse cx="7.5" cy="11.5" rx="2.6" ry="5" transform="rotate(-24 7.5 11.5)" fill="url(#ambergrad)" />
      <ellipse cx="16" cy="8.5" rx="2.7" ry="5.6" fill="url(#ambergrad)" />
      <ellipse cx="24.5" cy="11.5" rx="2.6" ry="5" transform="rotate(24 24.5 11.5)" fill="url(#ambergrad)" />
    </svg>
  )
}
